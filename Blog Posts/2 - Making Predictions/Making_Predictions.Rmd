...
we trained sets of networks based on works by Merry Shelley, Jane Austen, and Lewis Carrol to make predictions based on character sequences of lengths 1, 5, 10, and 30.
...
We do so based on the models trained on Merry Shelley's Frankenstein,
