...
Additionally, the tensorflow models need numerical inputs -- not characters.
...
The first set of observations is encoded in the machine-readable format tensorflow needs.
...
Shelley_df_seq_5 <-  read_csv(here("Data/Training_Data/Merry Shelley/df_seq_5.csv"))
